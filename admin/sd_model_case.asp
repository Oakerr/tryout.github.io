...
''' 修改：IT平民 in 2014.07
	...
	sub adddb()
		...
		sdcms.db.insert "sd_model_case",eval(fstr)
	...
	sub editdb()
		...
		sdcms.db.dbupdate "sd_model_case","cid="&id&"",eval(fstr)
	...
	select case act
		...
		case "edit","publish"
			...
			likeid=data(10,0)
			dim rsshow
			set rsshow=sdcms.db.exedb("select top 1 * from sd_model_case where cid="&id&"")
			if rsshow.eof then
