...
''' 修改：IT平民 in 2014.07
	...
	sub adddb()
		...
		sdcms.db.insert "sd_model_file",eval(fstr)
	...
	sub editdb()
		...
		sdcms.db.dbupdate "sd_model_file","cid="&id&"",eval(fstr)
	...
	select case act
		...
		case "edit","publish"
			...
			likeid=data(10,0)
			dim rsshow
			set rsshow=sdcms.db.exedb("select top 1 * from sd_model_file where cid="&id&"")
			if rsshow.eof then
