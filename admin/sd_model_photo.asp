...
''' 修改：IT平民 in 2014.07
	...
	sub adddb()
		...
		sdcms.db.insert "sd_model_photo",eval(fstr)
	...
	sub editdb()
		...
		sdcms.db.dbupdate "sd_model_photo","cid="&id&"",eval(fstr)
	...
	select case act
		...
		case "edit","publish"
			...
			set rsshow=sdcms.db.exedb("select top 1 * from sd_model_photo where cid="&id&"")
			if rsshow.eof then
