...
''' 修改：IT平民 in 2014.07
	...
	sub adddb()
		...
		t14=sdcms.enhtml(sdcms.fpost("like",0))
		...
		if sdcms.strlen(t2)=0 then sdcms.ajaxjson "&#35270;&#39057;&#19981;&#33021;&#20026;&#31354;",0:exit sub
		if sdcms.strlen(t19)>0 then
			if not(sdcms.checkstr(t19,"urlname")) then
				sdcms.ajaxjson "文件名称错误，不能包含特殊字符",0:exit sub
			end if
			if sdcms.db.dbcount("sd_content","url='"&t19&"'")>0 then
		...
		deal_tags "",t1
		data=array(array("title",t0,255,1),array("tags",t1,255,1),array("keyword",t4,255,1),array("description",t5,255,1),array("pic",t6,255,1),array("hits",t8,10,0),array("islock",t9,1,0),array("isnice",t10,1,0),array("ontop",t11,1,0),array("iscomment",t12,1,0),array("createdate",fuckdate(t13),50,1),array("likeid",t14,0,1),array("style",style,0,1),array("ispic",o1,1,0),array("lastupdate",fuckdate(o2),50,1),array("classid",o3,0,0),array("isurl",0,1,0),array("comments",0,0,0),array("adminid",adminid,0,0),array("userid",0,0,0),array("author",t15,50,1),array("comefrom",t16,50,1),array("intro",t17,0,1),array("point",t18,10,0),array("url",t19,255,1))
		sdcms.db.insert "sd_content",data
		dim cid:cid=sdcms.db.insertid("id","sd_content")		
		fstr="array(array(""cid"",cid,0,0),array(""content"",t3,0,1),array(""video"",t2,255,1),array(""playtime"",t7,50,1),array(""vtype"",vtype,50,1)"&fstr&")"
		
		sdcms.db.insert "sd_model_video",eval(fstr)
		if sdcms.strlen(t19)=0 then sdcms.deal_content_url cid,o3
		deal_file cid,1
	...
	sub editdb()
		dim t0,t1,t2,t3,t4,t5,t6,t7,t8,t9
		dim t10,t11,t12,t13,t14,t1_0,t15,t16,t17,t18,t19
		dim o0,o1,o2
		dim s0,s1,s2,style,up,frist
		...
		if sdcms.strlen(t19)>0 then
			...
			if sdcms.db.dbcount("sd_content","url='"&t19&"' and id<>"&id&"")>0 then
				sdcms.ajaxjson "文件名称已存在，请更换！",0:exit sub
			end if
		end if
		if up=1 then
		...
		deal_tags t1_0,t1
		data=array(array("title",t0,255,1),array("tags",t1,255,1),array("keyword",t4,255,1),array("description",t5,255,1),array("pic",t6,255,1),array("hits",t8,10,0),array("islock",t9,3,0),array("isnice",t10,1,0),array("ontop",t11,1,0),array("iscomment",t12,1,0),array("createdate",fuckdate(t13),50,1),array("likeid",t14,0,1),array("style",style,0,1),array("ispic",o1,1,0),array("lastupdate",fuckdate(o2),50,1),array("author",t15,50,1),array("comefrom",t16,50,1),array("intro",t17,0,1),array("point",t18,10,0),array("url",t19,255,1))
		sdcms.db.dbupdate "sd_content","id="&id&" and classid="&classid&"",data
		fstr="array(array(""content"",t3,0,1),array(""video"",t2,255,1),array(""playtime"",t7,50,1),array(""vtype"",vtype,50,1)"&fstr&")"
		sdcms.db.dbupdate "sd_model_video","cid="&id&"",eval(fstr)
		if t9=1 and old_lock<0 then sdcms.deal_user_publish_point id,""
	...
	select case act
		...
		case "edit","publish"
			...
			likeid=data(10,0)
			dim rsshow
			set rsshow=sdcms.db.exedb("select top 1 * from sd_model_video where cid="&id&"")
			if rsshow.eof then
