...
''' 修改：IT平民 in 2014.07
	...
	sub paydb
		...
		if t2=2 then
			if amount<t1 then
				sdcms.ajaxjson "0&#29992;&#25143;&#36134;&#25143;&#20313;&#39069;&#19981;&#36275;&#65292;&#26080;&#27861;&#25187;&#38500;",0
				exit sub
			end if
			namount=amount-t1
		else
		...
		sdcms.createusermoney array(array("amount",t1,10,0),array("type",t2,1,0),array("userid",userid,0,0),array("content",t3,255,1),array("createdate",sqltime,0,0))
	...
	dim statitle
	select case act
		case "pay":load theme_user_moneypay
		case "tip":gettip
		case "paydb":paydb
		case "del":del
		case "delall":delall
		...
		case "paylist":load theme_user_moneypaylist
		case else
